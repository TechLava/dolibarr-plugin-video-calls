...
/**
 * \file    test/functional/WebrtcFunctionalTest.php
 * \ingroup webrtc
 ...
 * @package Testwebrtc
 */
class WebrtcFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/webrtc/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('webrtc/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/webrtc/admin/about.php');
		$this->authenticate();
		return $this->assertContains('webrtc/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('webrtcwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
        ...
        return $this->assertContains(
			'interface_99_modWebrtc_WebrtcTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
        ...
        return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modWebrtc_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
